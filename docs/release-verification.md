...
photographs read from the cache, validation and split, the ImageNet-1k inference contract, the majority floor, the k-NN vote,
...
REL1/REL10, and it ran with the snapshot and the 180 photographs pre-staged, so neither the 346 MB Hub fetch nor the
